...
# Include a Gemfile for the sake of Bundler. You might want to run a
# specific version of Cucumber, or run Cucumber within some IDE tool
# (e.g. RubyMine) that automatically wraps the Gem execution
